...
import UpdateInstanceVersionModal from './UpdateInstanceVersionModal.jsx';
      ...
      >
        ...
        <div className="settings-layout instance-settings-layout" style={{ gridTemplateColumns: '200px 1fr' }}>
          ...
          <div>
            <div className="card" style={{ marginBottom: 14 }}>
              <div className="instance-form-field" style={{ marginBottom: 14 }}>
                <InstanceIconPicker
                  ...
                  value={icon}
                  onChange={setIcon}
                  modpackIcon={instance.modpackIcon}
                />
              </div>
            ...
            >
              <div>
                <div style={{ fontWeight: 600, marginBottom: 4 }}>{t('iset.changeVersion')}</div>
                <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
                  {instance.mcVersion}
                  {instance.loader !== 'vanilla' ? ` · ${instance.loader}` : ''}
                </div>
              </div>
              <button className="btn-primary btn-icon-label" onClick={() => setShowVersionUpdate(true)}>
                <Icon name="swap" size={14} />
                {t('iset.changeVersionBtn')}
              </button>
            </div>
        ...
        {section === 'installation' && (
          <div>
            ...
            <div className="card" style={{ marginBottom: 14 }}>
              <div style={{ fontWeight: 700, marginBottom: 4 }}>{t('iset.changeVersion')}</div>
              <p style={{ fontSize: 12, color: 'var(--text-secondary)', marginTop: 0, marginBottom: 12 }}>
                {t('iset.changeVersionHint')}
              </p>
              <button className="btn-secondary btn-icon-label" onClick={() => setShowVersionUpdate(true)}>
                <Icon name="swap" size={14} />
                {t('iset.changeVersionBtn')}
              </button>
            </div>
