...
const DEFAULT_SERVERS = [
  {
    ...
    host: '144.202.83.124',
    port: 4016,
    // Dirección "linda" para mostrar y copiar (ver ipLabel en
    // MinecraftServerList.jsx): el dominio caraotamc.top todavía no
    // resuelve al server real, así que host/port de arriba (la IP numérica)
    // siguen siendo los que se usan de verdad para el ping, el botón
    // "Jugar" y el servers.dat — displayHost es puramente cosmético.
    displayHost: 'caraotamc.top',
  },
  {
    id: 'arefy',
    name: 'Arefy Network',
